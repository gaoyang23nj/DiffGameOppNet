...
from RWP_dataset.MovementModelRWP import MovementModelRWP
...
class DTNNode(object):
    def __init__(self, *args):
        if args[0] is 'RandomWalk':
            ...
            self.MovementModel = MovementModelRWP(steptime, maxwidth=maxwidth, maxheight=maxheight)
        elif args[0] is 'SPM':
            ...
            print('ERROR! DTNNode.__init__() noSPM')
        else:
