...
from Helsinki_dataset.MovementModelShortestPath import MovementModelShortestPathMap
...
class WKTPathReader(object):
    ...
    def readthedata(self):
        ...
        for file in files:
            ...
            self.readwktfile(os.path.join(self.data_dir, file))
